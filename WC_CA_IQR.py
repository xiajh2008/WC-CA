...
def boxplot_alpha_and_min_angle(data_size, ptnn, alpha, t, cluster_label, rnns):
...
def wc_ca_clustering(data_embedding, t, k, threshold_stability):
    ...
    """---------------------------------------------------------------------------------"""
    fbp, rbp = boxplot_alpha_and_min_angle(data_size, ptnn, alpha, t, cluster_label, rnns)
